...
class ConfigTestCase(MFATestCase):
    ...
    def test_recovery_default_name(self):
        """Test that recovery method shows default name when not in MFA_RENAME_METHODS.
    ...
    def test_recovery_renamed(self):
        """Test that recovery method shows custom name when in MFA_RENAME_METHODS.
    ...
    def test_methods_disallowed(self):
        """Test MFA behavior when specific methods are disallowed.
    ...
    def test_enforced_recovery_behavior(self):
        """Test that enforced recovery method behaves correctly.
    ...
    def test_hide_disable_does_not_affect_dropdown_visibility(self):
        """Test that MFA_HIDE_DISABLE setting does not remove methods from dropdown menu.
    ...
    def test_hide_disable_method_shows_static_status(self):
        """Test that methods in MFA_HIDE_DISABLE show static status instead of toggle button.
    ...
    def test_hide_disable_method_shows_no_delete_button(self):
        """Test that methods in MFA_HIDE_DISABLE show no delete button.
    ...
    def test_hide_disable_method_endpoints_still_work(self):
        """Test that methods in MFA_HIDE_DISABLE are still functional.
    ...
    def test_method_default_names(self):
        """Test that methods not in settings use template default names.
    ...
    def test_method_custom_names(self):
        """Test that methods in MFA_RENAME_METHODS use custom names.
    ...
    def test_method_name_case_sensitivity(self):
        """Test that method names in MFA_RENAME_METHODS are case sensitive.
    ...
    def test_method_hiding_wrong_case_totp(self):
        """Test that TOTP method is not hidden when using wrong case in MFA_HIDE_DISABLE.
    ...
    def test_method_hiding_wrong_case_email(self):
        """Test that Email method is not hidden when using wrong case in MFA_HIDE_DISABLE.
    ...
    def test_disable_totp_interactive_elements_correct_case(self):
        """Test that TOTP method's interactive elements are disabled when using correct case in MFA_HIDE_DISABLE.
    ...
    def test_mfa_method_dropdown_visibility(self):
        """Test that MFA methods appear correctly in dropdown menu.
    ...
    def test_recovery_key_table_visibility(self):
        """Test that recovery keys appear correctly in the table.
    ...
    def test_disallowed_method_visibility(self):
        """Test that disallowed methods are hidden from UI but endpoints remain accessible.
