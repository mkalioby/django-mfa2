...
class MFAViewsTestCase(MFATestCase):
    ...
    def test_key_toggle_restrictions(self):
        ...
        self.login_user()
        key = self.create_totp_key()
        response = self.client.post(reverse('mfa:toggle_key', args=[key.id]))
        self.assertEqual(response.status_code, 200)
    ...
    def test_protected_url_redirect(self):
        """Test that protected URLs redirect to MFA."""
        self.skip_if_middleware_disabled("URL protection requires middleware")
    ...
    def test_session_handling(self):
        ...
        self.skip_if_middleware_disabled("Session handling requires middleware")
    ...
    def test_view_logging(self):
        ...
        self.skip_if_logging_gap("View logging not implemented")
